...
workflow segmentation {
    ...
    Int mem_gb = 16
    String docker_image = "gcr.io/pici_internal/tiff-tools:latest"
    ...
    String outconflicted = if !rename_to_sampleid then "conflicted_typed_segments.csv" else (sample_id + "_conflicted_typed_segments.csv")
    ...
    call type_segments.runAssignment as runAssignment { 
        ...
        hierarchy=hierarchy,
        outfile=outsegments,
        outfile_conflicted=outconflicted
